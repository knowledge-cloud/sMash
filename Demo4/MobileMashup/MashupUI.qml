...
Rectangle {
    ...
    property bool justMusic: true // indicate it's just playing music or run a music mashup.
...
//                mainWindow.state = "baseState";
                ...
                /* no home screen, run the music player again.*/
                mainWindow.state = "executeState";
                Engine.engine.init();
                Engine.engine.run();
            }
        ...
        Button {
            ...
            Component.onCompleted:resultViewPrevBtn.clicked.connect(prevResult);
    ...
    Button {
        ...
        Component.onCompleted:showMusicButton.clicked.connect(openPlayer);
    }
}
