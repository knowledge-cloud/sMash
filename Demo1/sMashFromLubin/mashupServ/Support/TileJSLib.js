...
//{tpName:Flickr  ,  operName:getGeotaggedPhotos  ,  type:root  ,  input:[<search_text beach>+++<number 15>]  ,  output:[title+++url+++thumbnailUrl+++owner+++linkUrl+++originalUrl+++latitude+++longitude+++id]  ,  parents:[]}    {tpName:VirtualEarth  ,  operName:addPushpin  ,  type:leaf  ,  input:[<latitude {Flickr.getGeotaggedPhotos.latitude}>+++<longitude {Flickr.getGeotaggedPhotos.longitude}>+++<url {Flickr.getGeotaggedPhotos.thumbnailUrl}>+++<title My Pushpin>+++<description This is a pushpin on the earth>]  ,  output:[]  ,  parents:[Flickr.getGeotaggedPhotos]}
