function (svc) {
    ...
    var weatherReport = function(cityName, latitude, longitude) {
	if (cityName == 'Urumqi')
		cityName = 'wulumuqi';
	...
	if (!currentWeather)
        ...
        var weather = { latitude: latitude, longitude: longitude, title: 'Weather Report ' + cityName, image: image, description: description };
    ...
    this.beginOutput = function() {
        ...
        for (var key in locations) {
            weatherReport(locations[key].cityName, locations[key].latitude, locations[key].longitude);
        }
        svc.output = weathers;
